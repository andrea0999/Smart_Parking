      ...
      <TableContainer component={Paper} className={classes.tableContainer}>
          <Table className={classes.table} aria-label="simple table">
            ...
            {show ? 
              ...
              <Modal.Header>
                <Modal.Title> {data.email} </Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <h2>Status</h2>
                <ul>
                  <ol>Role: {data.role}</ol>
                  <ol>Exp_data: {data.exp_data}</ol>
                  <ol>Mat_number: {data.mat_number}</ol>
                  <ol>Reserved: {data.reserved}</ol>
                </ul>
              </Modal.Body>
              <Modal.Footer>
